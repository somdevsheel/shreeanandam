    ...
    <div className="pt-16 md:pt-20">
      ...
      >
        ...
        <div className="relative">
          <p className="font-devanagari text-saffron-300 text-2xl mb-2">हमसे मिलें</p>
          <h1 className="font-display text-5xl md:text-6xl text-white mb-4">Visit Us</h1>
          <p className="text-cream-300 max-w-xl mx-auto px-4">
            We're open every day. Come as you are — a table is always waiting.
          </p>
        </div>
      </div>
