...
export default function ContactSection() {
  const { address, phone, whatsapp, hours, mapEmbedUrl } = restaurantInfo;
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-5">
            ...
            <div className="rounded-2xl p-6" style={{ background: "#261507", border: "1px solid rgba(200,120,30,0.2)" }}>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-display text-xl text-saffron-300 mb-2">Phone</h3>
                  <a href={`tel:${phone}`} className="text-saffron-400 font-medium text-lg hover:text-saffron-300 hover:underline transition-colors">
                    {phone}
                  </a>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                href={`https://wa.me/${whatsapp}?text=Hi%2C%20I'd%20like%20to%20make%20a%20reservation%20at%20Shree%20Anandam`}
          ...
          <div className="rounded-2xl overflow-hidden h-[420px] md:h-full min-h-[420px]" style={{ border: "1px solid rgba(200,120,30,0.25)" }}>
            <iframe
              ...
              title="Shree Anandam Restaurant Location"
            />
          </div>
        </div>
      </div>
